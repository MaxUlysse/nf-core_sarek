...
def helpMessage() {
    ...
    Options:
        ...
        --joint_calling             Perform Joint Calling based on HaplotypeCaller calls
...
(vcfConcatenated, vcfConcatenatedForFilter, vcfConcatenatedForJointCalling) = vcfConcatenated.into(3)
...
// STEP GATK JOINT CALLING.1 - Consolidate GVCFs

vcfConcatenatedForJointCalling.branch{
    haplotypecaller: it[0] == "HaplotypeCallerGVCF" && statusMap[it[1], it[2]] == 0
}.set {vcfForJointCalling}
